...
- images: Array of up to 12 image objects from the IMAGES FOUND ON PAGE list. Be AGGRESSIVE — grab everything useful. Each: { "url": "full URL", "description": "what the image shows", "type": "product|logo|screenshot|lifestyle|hero|packaging|detail|brand" }. Pick the HIGHEST RESOLUTION version — look for URLs without size suffixes like "_100x", "-150x150", or "?width=200". INCLUDE: product photos, logos (PNG/SVG/any format), lifestyle shots, detail/close-up shots, hero banners, screenshots, packaging, brand imagery, comparison charts, infographics, before/after images. SKIP: 1x1 tracking pixels, generic UI elements like arrows/chevrons, social media share icons, video thumbnails/poster frames (images whose URL contains "video", "poster", "thumb" near a video context, or that are clearly a frame from a video player), and any image URL that looks like a video CDN frame grab.
