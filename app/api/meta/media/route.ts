...
export async function GET(request: NextRequest) {
  try {
    ...
    if (type === 'all' || type === 'images') {
      const imagesUrl = `https://graph.facebook.com/v18.0/act_${cleanAdAccountId}/adimages?fields=id,hash,name,permalink_url,width,height,created_time,bytes&limit=100&access_token=${accessToken}`
