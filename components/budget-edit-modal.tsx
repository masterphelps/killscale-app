        ...
        <div className="p-4">
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                min="1"
                step="1"
                className="w-full pl-9 pr-4 py-3 bg-bg-dark border border-border rounded-lg text-white text-lg font-mono focus:outline-none focus:border-accent transition-colors"
              />
            </div>
            {budgetType === 'daily' && (
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              disabled={isLoading}
              className="flex-1 py-2.5 px-4 bg-bg-hover text-zinc-300 rounded-lg font-medium hover:text-white transition-colors disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              onClick={handleSave}
              disabled={isLoading}
              className="flex-1 py-2.5 px-4 bg-accent text-white rounded-lg font-medium hover:bg-accent-hover transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
